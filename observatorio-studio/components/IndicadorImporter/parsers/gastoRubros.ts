...
function parsePorcentajes(
  ...
  return {
    ...
    descripcionContexto: `Gasto ejercido por rubro en el municipio de ${muni.display}, distribución porcentual anual.`,
    ocultarValores: true,
  }
}
...
function parseMontos(
  ...
  return {
    ...
    fuente: 'otra',
    fuentePersonalizada: `Transparencia Municipal del Ayuntamiento de ${muni.display}`,
    descripcionContexto: `Gasto ejercido por rubro en el municipio de ${muni.display}, montos anuales en pesos.`,
  }
}
